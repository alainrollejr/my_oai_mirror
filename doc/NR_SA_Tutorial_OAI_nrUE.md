...
```bash
sudo ./nr-uesoftmodem -r 273 --numerology 1 --band 78 -C 3750000000 --ssb 1478 --usrp-args "addr=192.168.40.111" --ue-fo-compensation --sa --uicc0.imsi 001010000000001 -A 90 
```
